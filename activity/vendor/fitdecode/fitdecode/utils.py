...
UNIT_NAME_TO_FUNC_REPLACEMENTS = (("/", " per "), ("%", "percent"), ("*", " times "))
...
def get_mesg_field(mesg_name_or_num, field_name_or_num):
    ...
    raise ValueError(f'field "{field_name_or_num}" not found in ' f'message "{mesg_name_or_num}"')
...
def get_mesg_field_num(mesg_name_or_num, field_name):
    ...
    raise ValueError(f'field "{field_name}" not found in message "{mesg_name_or_num}"')
